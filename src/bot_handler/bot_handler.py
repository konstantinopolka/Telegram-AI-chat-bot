...
class BotHandler:
    ...
    def _logged_message_handler(self, **kwargs):
    ...
    def _register_handlers(self):
        ...
        @self._logged_message_handler(commands=['help', 'start'])
        ...
        @self._logged_message_handler(commands=['rules'])
        ...
        @self._logged_message_handler(func=lambda message: True)
